...
client.on("ready", () => {
	...
	client.application?.commands?.create(registerObjects['help']);
	client.application?.commands?.create(registerObjects['configure']);
	client.application?.commands?.create(registerObjects['settings']);
	client.application?.commands?.create(registerObjects['catch']);
	client.application?.commands?.create(registerObjects['leaderboard']);
	client.application?.commands?.create(registerObjects['score']);
	client.application?.commands?.create(registerObjects['mod']);
});
